        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="atualizar">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" wire:model.defer="nome" class="form-control" placeholder="Nome completo"
                        style="border-radius: 8px; box-shadow: 0 0 5px rgba(0, 123, 255, 0.2);">
                    @error('nome')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" wire:model.defer="telefone" class="form-control" placeholder="(XX) XXXXX-XXXX"
                        style="border-radius: 8px; box-shadow: 0 0 5px rgba(0, 123, 255, 0.2);">
                    @error('telefone')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" wire:model.defer="cpf" class="form-control" placeholder="000.000.000-00"
                        style="border-radius: 8px; box-shadow: 0 0 5px rgba(0, 123, 255, 0.2);">
                    @error('cpf')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                {{-- Senha --}}
                <div class="mb-4">
                    <label class="form-label" style="color: #333; font-weight: 600;">Senha <span
                            class="text-muted">(opcional)</span></label>
                    <input type="password" wire:model.defer="password" class="form-control" placeholder="Nova senha"
                        style="border-radius: 8px; box-shadow: 0 0 5px rgba(0, 123, 255, 0.2);">
                    @error('password')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"
                        style="border-radius: 8px; padding: 12px 0; font-weight: 600; background-color: #007bff; border: none;">
                        Atualizar Cliente
                    </button>
